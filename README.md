...
* [SSProve](https://github.com/SSProve/ssprove) ⭐ 74 | 🐛 14 | 🌐 Rocq Prover | 📅 2026-02-05 - Framework for modular cryptographic proofs based on the Mathematical Components library.
...
* [VsCoq](https://github.com/coq-community/vscoq) ⭐ 433 | 🐛 180 | 🌐 OCaml | 📅 2025-12-10 - Language server and extension for the Visual Studio Code and VSCodium editors.
* [VsCoq Legacy](https://github.com/coq-community/vscoq/tree/vscoq1) ⭐ 433 | 🐛 180 | 🌐 OCaml | 📅 2025-12-10 - Backwards-compatible extension for the Visual Studio Code and VSCodium editors using Coq's legacy XML protocol.
...
* [Coqtail](https://github.com/whonore/Coqtail) ⭐ 316 | 🐛 39 | 🌐 Python | 📅 2026-02-07 - Interface for Coq based on the Vim text editor.
* [Coq LSP](https://github.com/ejgallego/coq-lsp) ⭐ 198 | 🐛 142 | 🌐 OCaml | 📅 2026-02-04 - Language server and extension for the Visual Studio Code and VSCodium editors with custom document checking engine.
...
* [Tree Sitter Rocq](https://github.com/lamg/tree-sitter-rocq) ⭐ 3 | 🐛 0 | 🌐 Rocq Prover | 📅 2025-08-17 - Partial Rocq tree-sitter grammar useful for syntax highlighting in text editors like [Helix](https://github.com/helix-editor/helix) ⭐ 42,917 | 🐛 1,437 | 🌐 Rust | 📅 2026-02-13, but not recommended for full parsing of Rocq code.
...
* [Formalised Undecidable Problems](https://github.com/uds-psl/coq-library-undecidability) ⭐ 131 | 🐛 17 | 🌐 Coq | 📅 2026-01-02 - Library of undecidable problems and reductions between them.
...
* [Bignums](https://github.com/coq/bignums) ⭐ 25 | 🐛 2 | 🌐 Rocq Prover | 📅 2026-02-11 - Library of arbitrarily large numbers.
...
* [Coq Platform](https://github.com/coq/platform) ⭐ 226 | 🐛 64 | 🌐 Shell | 📅 2026-02-05 - Curated collection of packages to support Coq use in industry, education, and research.
* [Coq Nix Toolbox](https://github.com/coq-community/coq-nix-toolbox) ⭐ 50 | 🐛 37 | 🌐 Nix | 📅 2026-02-13 - Nix helper scripts to automate local builds and continuous integration for Coq.
* [Docker-Coq](https://github.com/coq-community/docker-coq) ⭐ 39 | 🐛 6 | 🌐 Shell | 📅 2025-05-13 - Docker images for many versions of Coq.
* [coq-community Templates](https://github.com/coq-community/templates) ⭐ 16 | 🐛 29 | 🌐 Mustache | 📅 2025-10-30 - Templates for generating configuration files for Coq projects.
...
* [MetaCoq](https://github.com/MetaCoq/metacoq) ⭐ 504 | 🐛 95 | 🌐 Rocq Prover | 📅 2026-02-13 - Project formalizing Coq in Coq and providing tools for manipulating Coq terms and developing certified plugins.
...
* [Equations](https://github.com/mattam82/Coq-Equations) ⭐ 236 | 🐛 91 | 🌐 Coq | 📅 2026-02-13 - Function definition package for Coq.
* [Coq-Elpi](https://github.com/LPCIC/coq-elpi) ⭐ 183 | 🐛 112 | 🌐 Rocq Prover | 📅 2026-02-13 - Extension framework based on λProlog providing an extensive API to implement commands and tactics.
...
* [Hierarchy Builder](https://github.com/math-comp/hierarchy-builder) ⭐ 104 | 🐛 111 | 🌐 Rocq Prover | 📅 2026-02-12 - Collection of commands for declaring Coq hierarchies based on packed classes.
...
* [Mtac2](https://github.com/Mtac2/Mtac2) ⭐ 56 | 🐛 70 | 🌐 Rocq Prover | 📅 2026-02-13 - Plugin adding typed tactics for backward reasoning.
...
* [Sail](https://github.com/rems-project/sail) ⭐ 841 | 🐛 287 | 🌐 Sail | 📅 2026-02-11 - Tool for specifying instruction set architecture (ISA) semantics of processors and generating Coq definitions.
* [Cosette](https://github.com/uwdb/Cosette) ⭐ 684 | 🐛 28 | 🌐 Lean | 📅 2024-12-18 - Automated solver for reasoning about SQL query equivalences.
* [Ott](https://github.com/ott-lang/ott) ⭐ 401 | 🐛 37 | 🌐 OCaml | 📅 2026-02-13 - Tool for writing definitions of programming languages and calculi that can be translated to Coq.
...
* [CoqOfOCaml](https://github.com/clarus/coq-of-ocaml) ⭐ 272 | 🐛 18 | 🌐 OCaml | 📅 2024-08-05 - Tool for generating idiomatic Coq from OCaml code.
...
* [Rocqnavi](https://github.com/affeldt-aist/rocqnavi) ⭐ 3 | 🐛 16 | 🌐 HTML | 📅 2026-01-27 - Fork of coq2html that adds indexes, clickable notations, Markdown and LaTeX formatting in comments, and more.
...
* [Category Theory in Coq](https://github.com/jwiegley/category-theory) ⭐ 793 | 🐛 7 | 🌐 Rocq Prover | 📅 2026-01-09 - Axiom-free formalization of category theory.
* [Analysis](https://github.com/math-comp/analysis) ⭐ 236 | 🐛 137 | 🌐 Rocq Prover | 📅 2026-02-12 - Library for classical real analysis compatible with Mathematical Components.
...
* [Fiat-Crypto](https://github.com/mit-plv/fiat-crypto) ⭐ 805 | 🐛 171 | 🌐 Rocq Prover | 📅 2026-02-13 - Cryptographic primitive code generation.
* [Jasmin](https://github.com/jasmin-lang/jasmin) ⭐ 330 | 🐛 130 | 🌐 Rocq Prover | 📅 2026-02-13 - Formalized language and verified compiler for high-assurance and high-speed cryptography.
...
* [CertiCoq](https://github.com/CertiCoq/certicoq) ⭐ 159 | 🐛 22 | 🌐 Rocq Prover | 📅 2026-02-09 - Verified compiler from Gallina, the internal language of Coq, down to CompCert's Clight language.
...
* [WasmCert-Coq](https://github.com/WasmCert/WasmCert-Coq/) ⭐ 114 | 🐛 4 | 🌐 Rocq Prover | 📅 2026-02-13 - Formalization in Coq of the WebAssembly (aka Wasm) 1.0 specification.
...
* [Official Coq wiki](https://github.com/coq/coq/wiki) ⭐ 5,350 | 🐛 2,535 | 🌐 OCaml | 📅 2026-02-13
* [Mathematical Components wiki](https://github.com/math-comp/math-comp/wiki) ⭐ 668 | 🐛 162 | 🌐 Rocq Prover | 📅 2026-02-04
